...
public final class PermissionUtils {
    ...
    public static void requestWriteSettings(final SimpleCallback callback) {
        ...
        PermissionActivity.start(Utils.getContext(), PermissionActivity.TYPE_WRITE_SETTINGS);
    }
    ...
    public static void requestDrawOverlays(final SimpleCallback callback) {
        ...
        PermissionActivity.start(Utils.getContext(), PermissionActivity.TYPE_DRAW_OVERLAYS);
    }
    ...
    private void startPermissionActivity() {
        ...
        PermissionActivity.start(Utils.getContext(), PermissionActivity.TYPE_RUNTIME);
    }
