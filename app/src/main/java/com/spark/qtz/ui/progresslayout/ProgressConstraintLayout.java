package com.spark.qtz.ui.progresslayout;
...
public class ProgressConstraintLayout extends ConstraintLayout implements ProgressLayout {
    ...
    private int mColor = Color.parseColor("#718495");
    ...
    private void init(AttributeSet attrs) {
        ...
        loadingStateProgressBarWidth =
                typedArray.getDimensionPixelSize(R.styleable.ProgressLayout_loadingProgressBarWidth, 120);

        loadingStateProgressBarHeight =
                typedArray.getDimensionPixelSize(R.styleable.ProgressLayout_loadingProgressBarHeight, 120);

        loadingStateProgressBarColor =
                typedArray.getColor(R.styleable.ProgressLayout_loadingProgressBarColor, mColor);
        ...
        emptyStateTitleTextColor =
                typedArray.getColor(R.styleable.ProgressLayout_emptyTitleTextColor, mColor);
        ...
        emptyStateContentTextColor =
                typedArray.getColor(R.styleable.ProgressLayout_emptyContentTextColor, mColor);
        ...
        errorStateTitleTextColor =
                typedArray.getColor(R.styleable.ProgressLayout_errorTitleTextColor, mColor);
        ...
        errorStateContentTextColor =
                typedArray.getColor(R.styleable.ProgressLayout_errorContentTextColor, mColor);

        errorStateButtonTextColor =
                typedArray.getColor(R.styleable.ProgressLayout_errorButtonTextColor, Color.WHITE);

        errorStateButtonBackgroundColor =
                typedArray.getColor(R.styleable.ProgressLayout_errorButtonBackgroundColor, mColor);
