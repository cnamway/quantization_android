package com.spark.qtz.ui.seekbar;
...
import static com.spark.qtz.ui.seekbar.BubbleUtils.dp2px;
import static com.spark.qtz.ui.seekbar.BubbleUtils.sp2px;
import static com.spark.qtz.ui.seekbar.SeekBar.TextPosition.BELOW_SECTION_MARK;
import static com.spark.qtz.ui.seekbar.SeekBar.TextPosition.BOTTOM_SIDES;
import static com.spark.qtz.ui.seekbar.SeekBar.TextPosition.SIDES;
...
public class SeekBar extends View {
    ...
    public boolean onTouchEvent(MotionEvent event) {
        switch (event.getActionMasked()) {
            ...
            case MotionEvent.ACTION_UP:
                LogUtils.e("seekbar","up");
            case MotionEvent.ACTION_CANCEL:
                LogUtils.e("seekbar","cancel");
    ...
    private void autoAdjustSection() {
        ...
        if (!onSection) {
            ...
            valueAnim.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                ...
                public void onAnimationUpdate(ValueAnimator animation) {
                    ...
                    if (mProgressListener != null) {
                        mProgressListener.onProgressChanged(SeekBar.this, getProgress(),
        ...
        animatorSet.addListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                if (mProgressListener != null) {
                    mProgressListener.getProgressOnFinally(SeekBar.this, getProgress(),
                            getProgressFloat(), true);
                }
            }
    ...
    public interface OnProgressChangedListener {
        ...
        void onProgressChanged(SeekBar bubbleSeekBar, int progress, float progressFloat, boolean fromUser);

        void getProgressOnActionUp(SeekBar bubbleSeekBar, int progress, float progressFloat);

        void getProgressOnFinally(SeekBar bubbleSeekBar, int progress, float progressFloat, boolean fromUser);
    }
