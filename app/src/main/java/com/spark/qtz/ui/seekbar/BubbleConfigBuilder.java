...
public class BubbleConfigBuilder {
    ...
    private SeekBar mBubbleSeekBar;

    BubbleConfigBuilder(SeekBar bubbleSeekBar) {
    ...
    public BubbleConfigBuilder sectionTextPosition(@SeekBar.TextPosition int position) {
