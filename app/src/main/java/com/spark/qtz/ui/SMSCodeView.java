...
import com.spark.qtz.util.DensityUtils;
 ...
 * ================================================
 */
public class SMSCodeView extends LinearLayout implements TextWatcher, View.OnClickListener, View.OnLongClickListener {
    ...
    private void showPopupWindow() {
        View popupwindow = LayoutInflater.from(mContext).inflate(R.layout.view_sms_code, null);
        final PopupWindow popupWindow = new PopupWindow(popupwindow, LinearLayout.LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT, true);
        popupWindow.showAsDropDown(this, getWidth() / 2, DensityUtils.dp2px(mContext, 5));
    ...
    private void init(final Context context) {
        ...
        LinearLayout.LayoutParams params = new LinearLayout.LayoutParams(
                DensityUtils.dp2px(mContext, borderSize), DensityUtils.dp2px(mContext, borderSize));
        params.setMargins(DensityUtils.dp2px(mContext, borderMargin), 0, 0, 0);
        //设置方格文字
        for (int i = 0; i < editViewNum; i++) {
            TextView textView = new TextView(mContext);
            textView.setBackgroundResource(R.drawable.sms_code_normal);
            textView.setGravity(Gravity.CENTER);
            textView.setTextSize(DensityUtils.sp2px(mContext, textSize));
