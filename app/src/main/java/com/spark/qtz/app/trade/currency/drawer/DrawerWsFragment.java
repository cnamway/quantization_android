...
import com.spark.qtz.app.quotes.viewpager.QuotesReceiveViewModel;
import com.spark.qtz.base.ARouterPath;
import com.spark.qtz.databinding.FragmentQuotesReceiveBinding;
 ...
 * ================================================
 */
public class DrawerWsFragment extends BaseFragment<FragmentQuotesReceiveBinding, QuotesReceiveViewModel> {
    private static final String TYPE = "type";
    private List<AllThumbResult.DataBean> mThumbList = new ArrayList<>();
    private DrawerAdapter mDrawerAdapter;
    private AllThumbResult firstAllThumbResult;

    public static DrawerWsFragment newInstance(String quotesType) {
        DrawerWsFragment drawerFragment = new DrawerWsFragment();
