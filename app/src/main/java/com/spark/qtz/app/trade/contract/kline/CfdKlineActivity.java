...
import com.spark.qtz.databinding.ActivityKlineCfdBinding;
 ...
 * ================================================
 */
@Route(path = ARouterPath.ACTIVITY_TRADE_CFD_KLINE)
public class CfdKlineActivity extends BaseActivity<ActivityKlineCfdBinding, CfdKlineViewModel> {
    ...
    public int initContentView(Bundle savedInstanceState) {
        return R.layout.activity_kline_cfd;
    }

    @Override
    public int initVariableId() {
        return BR.cfdKlineViewModel;
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.kline_load_full_screen:
                ...
                ARouter.getInstance().build(ARouterPath.ACTIVITY_TRADE_CFD_KLINE_HORIZONTAL)
                        .withParcelable("cfdThumbClick", allThumbResult)
                        .navigation();
                break;
        }
    }
