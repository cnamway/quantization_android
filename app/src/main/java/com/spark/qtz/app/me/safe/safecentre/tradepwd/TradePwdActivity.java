package com.spark.qtz.app.me.safe.safecentre.tradepwd;
...
import com.spark.qtz.databinding.ActivityTradePwdBinding;
 ...
 * ================================================
 */
@Route(path = ARouterPath.ACTIVITY_ME_TRADE_PASS)
public class TradePwdActivity extends BaseActivity<ActivityTradePwdBinding, TradePwdViewModel> {
    @Autowired
    int isFirst;
