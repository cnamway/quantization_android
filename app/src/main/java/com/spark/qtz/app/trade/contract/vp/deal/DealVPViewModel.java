package com.spark.qtz.app.trade.contract.vp.deal;
 ...
 * ================================================
 */
public class DealVPViewModel extends BaseViewModel {
    public DealVPViewModel(@NonNull Application application) {
        super(application);
    }
    ...
    public void initSreenName(String screenName){
    ...
    public void loadDealData(String symbol, int pageNo, OnRequestListener onRequestListener) {
        ...
        CfdClient.getInstance().orderDeal(symbol, pageNo);
        LogUtils.e("cfdVpRequest", "loadDealData");
    }
    ...
    public void onEvent(final EventBean eventBean) {
        switch (eventBean.getOrigin()) {
            ...
            case EvKey.cfdOrderDeal:
                ...
                break;
            case EvKey.cfdRefreshSceenName:
                initSreenName(eventBean.getMessage());
                break;
            //刷新
