 ...
 * ================================================
 */
public class KlineHttpHorizontalViewModel extends BaseViewModel {
    ...
    public KlineHttpHorizontalViewModel(@NonNull Application application) {
        super(application);
    }
    ...
    public void onCreate() {
        super.onCreate();
        Constant.isKineHorizontalVisiable = true;
    ...
    public void onDestroy() {
        super.onDestroy();
        Constant.isKineHorizontalVisiable = false;
        unSubscribeKline();
