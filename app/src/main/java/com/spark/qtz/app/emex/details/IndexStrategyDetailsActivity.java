...
import com.spark.qtz.databinding.ActivityIndexStrategyDetailsBinding;
...
@Route(path = ARouterPath.ACTIVITY_EMEX_STRATEGY_DETAILS)
public class IndexStrategyDetailsActivity extends BaseActivity<ActivityIndexStrategyDetailsBinding, IndexStrategyDetailsViewModel> {
    ...
    public int initContentView(Bundle savedInstanceState) {
        return R.layout.activity_index_strategy_details;
    }

    @Override
    public int initVariableId() {
        return BR.indexStrategyDetailsViewModel;
    }
    ...
    public void initView() {
        ...
        mTitleModel.setTitleName(getString(R.string.str_strategy_details));
