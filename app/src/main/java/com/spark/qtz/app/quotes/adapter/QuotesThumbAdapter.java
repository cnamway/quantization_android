 ...
 * ================================================
 */
public class QuotesThumbAdapter extends BaseQuickAdapter<AllThumbResult.DataBean, QuotesThumbAdapter.CoinPairPushBeanViewHolder> {
    public QuotesThumbAdapter(@Nullable List<AllThumbResult.DataBean> data) {
        super(R.layout.item_quotes_thumb, data);
    }

    @Override
    protected void convert(CoinPairPushBeanViewHolder helper, AllThumbResult.DataBean item) {
        ViewDataBinding binding = helper.getBinding();
        binding.setVariable(BR.allThumbResult, item);
