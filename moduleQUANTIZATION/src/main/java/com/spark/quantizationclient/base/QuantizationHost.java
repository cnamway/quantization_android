package com.spark.quantizationclient.base;


public class QuantizationHost {
...
//    public static String phoneCaptchaUrl = "captcha/mm/phone";
    ...
    /************************************************************************************/
    public static String userInfoUrl = "trader/getInfo";
    public static String memberListUrl = "member/info/find/page";
}
